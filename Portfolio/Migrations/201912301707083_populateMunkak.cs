namespace Portfolio.Migrations
{
    ...
    public partial class populateMunkak : DbMigration
    {
        ...
        {   
            ...
            Sql($"INSERT INTO Munkaims(Csillagozott,Cim,Leiras,HozzaadasDatuma) VALUES(0,'Scifi Shield','Particles reacting to randomly generated shots particle simulation based on Steven Knipping tutorial. All done inside of Houdini, rendered with Mantra','{DateTime.Now.ToString("yyyy - MM - dd")}');");
